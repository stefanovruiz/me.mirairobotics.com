...
$charDesc = array();
$charClass = array();
 $charDesc[0] = "<p><b>Description</b>: Humans come in a broad variety of shapes and sizes. "
 ...
 $charDesc[1] = "<p><b>Description</b>: Elves are a slender race, with both genders
...
and +2 vs. Magic Wands and Spells.</p>";
 ...
 $charDesc[2] = "<p><b>Description</b>: Dwarves are a short, stocky race; both male
...
<p><b>Saving Throws: Dwarves save at +4 vs. Death Ray or
Poison, Magic Wands, Paralysis or Petrify, and Spells, and
at +3 vs. Dragon Breath.</p>";
 
 $charDesc[3]= "<p><b>Description</b>: Halflings are small, slightly stocky folk who
...
at +3 vs. Dragon Breath.</p>";
 ...
 //class array
 $charClass[0] ="<p>Fighters include soldiers, guardsmen, barbarian warriors,
...
use any weapon.</p>";
 $charClass[1] = "<p>Clerics are those who have devoted themselves to the
...
club, quarterstaff, and sling).</p>";
 $charClass[2] = "<p>Thieves are those who take what they want or need by
...
however.</p>";
 ...
 $charClass[3] = "<p>Magic-Users are those who seek and use knowledge of the
